  ...
  return (
    <>
      <Header
        ...
        onClickLogin={() => setShowRegisterForm(false)}
        onClickRegister={() => setShowRegisterForm(true)}
      />
      ...
      <main>
          ...
          <section className="todo-list-wrapper">
            ...
            {editingId === todo.id ? (
              ...
              <div className="todo-text">
                ...
                <span className="todo-created-at">作成日時: {new Date(todo.createdAt).toLocaleString('ja-JP')}</span>
              </div>
        ...
        <section className="auth-wrapper">
         <div className="auth-card">
            <h2>{showRegisterForm ? '会員登録' : 'ログイン'}</h2>
           ...
           <div className="auth-toggle">
            {showRegisterForm ? (
              <>
                ...
                <button onClick={() => setShowRegisterForm(false)}>ログイン</button>
              </>
            ) : (
              <>
                <span>アカウントをお持ちではありませんか？</span>
                <button onClick={() => setShowRegisterForm(true)}>会員登録</button>
              </>
            )}
            </div>
          </div>
